...
// while petlja , while radi sa boolean tipom podatka
// sve dok je true
...
const brojUnos='1262'  // simuliram da je unio korisnik

// zbroji sve znamenke broja

// treba biti 11

console.time('ZB1') //ZB1 je zbrajanje brojeva 1
suma=0
for(let i=0;i<brojUnos.length;i++)
{

    suma+=Number(brojUnos[i])  // ovo pozivam 4 puta i imam vrijednost 0.04
...
let broj=Number(brojUnos)   // ovo pozivam jednom
...
// citati vise o optimizaciji

// Tablica kompleksnosti big o notation


// u for i while ptlju se ne mora uci
...
while(podaciAPI.length>0){
    console.log('Ušao u petlju', podaciAPI.pop()?.ime)  // funkcija pop uzima zadnji element niza i skracuje niz za jedan
