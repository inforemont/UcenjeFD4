...
obrazac.addEventListener('submit', (dogadaj) => {
    ...
    try {
        const konacniPodaci = {
            projekt: provjeriTekst(document.getElementById('naziv-projekta'), 'Naziv projekta min. 4 znaka'),
            mjesto: provjeriTekst(document.getElementById('mjesto-instalacije'),'Mjesto instalacije min. 4 znaka'),
            ...
            cijena: provjeriDecimalniBroj(document.getElementById('cijena')),
