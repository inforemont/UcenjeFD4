...
class Konfiguracija extends EdunovaObrada {
    ...
    get mjesto() { return this.#mjesto; }
    set mjesto(v) { this.#mjesto = v; }
    ...
    provjeriValjanost(el) {
        ...
        this.#mjesto = izvrsiProvjeru(Pomocno.provjeriString, el.projekt, 8, 'Mjesto projekta minimalno 8 znaka.');
