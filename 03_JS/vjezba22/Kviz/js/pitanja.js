function kreirajPitanja() {
    ...
    // Prolazimo kroz svako pitanje i miješamo njegov niz odgovora
    pitanja.forEach(p => {
        p.odgovori.sort(() => 0.5 - Math.random());
    });

    // Miješanje redoslijeda samih pitanja
    return pitanja.sort(() => 0.5 - Math.random());
}